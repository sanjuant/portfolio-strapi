...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    protectedEmail: Schema.Attribute.String;
    protectedPhone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    rootme: Schema.Attribute.String;
...
export interface ApiEducationAndTrainingEducationAndTraining
  extends Struct.CollectionTypeSchema {
  collectionName: 'educations_and_trainings';
  info: {
    description: '';
    displayName: 'Education and training';
    pluralName: 'educations-and-trainings';
    singularName: 'education-and-training';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    graduating_certification: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::education-and-training.education-and-training'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about_me: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    writer: Schema.Attribute.Component<'hero.writer', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiIdentityIdentity extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    soft_skills: Schema.Attribute.Component<'identity.soft-skills', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProfessionnalExperienceProfessionnalExperience
  extends Struct.CollectionTypeSchema {
  collectionName: 'professionnal_experiences';
  info: {
    description: '';
    displayName: 'Professionnal Experience';
    pluralName: 'professionnal-experiences';
    singularName: 'professionnal-experience';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::professionnal-experience.professionnal-experience'
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> &
      Schema.Attribute.SetPluginOptions<{
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::education-and-training.education-and-training': ApiEducationAndTrainingEducationAndTraining;
